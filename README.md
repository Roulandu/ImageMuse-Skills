...
4 个技能会按意图在 `最终中文提示词` 中加入固定中文风格锚点。基础锚点默认包含成人年龄、成熟丰腴且比例协调的整体体态、自然端正姿态、明亮室内或高级家居自然光场景、优雅合身服装；泳装 Lookbook、女仆/甜美幻想风、回眸姿势和 S 型身材只在用户输入或修复目标匹配时追加。这些锚点用于整体人像、服装版型和高级时尚构图，不用于身体局部特写或低俗凝视。
