...
```text
使用 $image2-adult-glamour-studio，生成一张成人原创女性高级人像的中文提示词，清冷、成熟、低饱和、窗边自然光。
```
...
```text
使用 $image2-fashion-lingerie-lookbook，生成一张成人原创模特的高级泳装 Lookbook 中文提示词，度假酒店泳池边，重点表现泳装版型和面料。
```
