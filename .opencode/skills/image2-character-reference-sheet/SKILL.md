...
- Prompt anchors: always include age, mature figure, natural posture, bright interior/light neutral background, and explicit safe clothing when provided or the default slip-dress clothing anchor when clothing is unspecified.
