...
- Avoid generic AI influencer beauty. Add specific but realistic face memory points, hair styling, makeup texture, garment material, lighting, and cover-design rhythm.
...
The **最终中文提示词** must fully carry the triggered required prompt anchors and the generated fictional poster/cover text. Other sections may summarize them briefly.
