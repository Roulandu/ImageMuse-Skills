...
Use this reference to convert crude or risky adult glamour wording into mature, non-explicit Image2 language.
...
- 性感 -> mature attractiveness, refined glamour, elegant confidence.
- 魅惑 -> mysterious elegance, expressive gaze, cinematic presence.
- 身材火辣 -> balanced silhouette, healthy proportions, fashion-led body line.
- 妩媚 -> mature softness, confident poise.
- 丰满 -> softly full figure, healthy mature proportions.
- 撩人 -> visually compelling yet restrained.
- 贴身 -> tailored fit, garment follows the silhouette.
- 曲线突出 -> natural flowing silhouette, balanced garment fit.
- 暧昧 -> soft cinematic mood, intimate-looking but non-voyeuristic atmosphere.
- 床上 -> bright lifestyle interior, editorial home setting, seated beside a bed with composed posture.
- 泳装 -> resort swimwear lookbook, product catalog, vacation styling.
- 内衣 -> adult fashion lingerie lookbook, lined fabric, garment construction, fit confirmation.
...
1. Sensitive desire term.
2. Mature aesthetic intent.
...
non-explicit, no nudity, no exposed private areas, no sexual pose, no body-part close-up, no low-angle body gaze, no minor-coded appearance, no student cues, no real-person likeness, no coercive or voyeuristic framing, natural anatomy, correct hands.
